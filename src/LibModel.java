...
public class LibModel {
    ...
    public void login(String id){
        ...
        try{
            ...
            System.out.println("Select PersonID, uName, UserType, PreferredBranch"
                                + "From person Where PersonID = " + id);
            ResultSet rs = 
                stmt.executeQuery("Select PersonID, uName, UserType, PreferredBranch"
                                + " From person Where PersonID = '" + id + "'");
    ...
    public String getBranch(int branchID){
        ...
        try{
            ...
            stmt = conn.createStatement();
            ResultSet rs = 
                stmt.executeQuery("SELECT BranchName FROM librarybranch Where '"
                                    + branchID + "'");
    ...
    public String[] getLibraries(){
        ...
        try{
            ...
            stmt = conn.createStatement();
            ResultSet rs = 
                stmt.executeQuery("SELECT BranchName FROM librarybranch");
